...
(function () {
  ...
  var css = '.post-layout{display:grid;grid-template-columns:1fr 260px;gap:24px;max-width:1200px;margin:0 auto;padding:20px 40px 40px}'
    ...
    + '.post-side{position:sticky;top:180px;align-self:start;display:flex;flex-direction:column;gap:16px;max-height:calc(100vh - 200px);overflow-y:auto;scrollbar-width:none;-ms-overflow-style:none}'
    + '.post-side::-webkit-scrollbar{display:none}'
